...
- Ризик для безпеки: ${config.risk}/3 (якщо ≥2 — заклади в характер серйозний ризик зриву/відміни або суїцидальних думок, які терапевт мусить помітити)`;
  ...
  // Шаблон кейсу (T5.1): авторський наратив-сід, якого озвучення має дотримуватись.
  if (config.templateBrief) {
    briefPrompt += `

Сценарій кейсу (дотримуйся його при створенні картки й прихованої моделі): ${config.templateBrief}`;
  }
